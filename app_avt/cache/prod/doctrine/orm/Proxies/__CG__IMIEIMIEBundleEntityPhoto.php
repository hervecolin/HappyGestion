 ...
 */
class Photo extends \IMIE\IMIEBundle\Entity\Photo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'IMIE\\IMIEBundle\\Entity\\Photo' . "\0" . 'id', '' . "\0" . 'IMIE\\IMIEBundle\\Entity\\Photo' . "\0" . 'url', '' . "\0" . 'IMIE\\IMIEBundle\\Entity\\Photo' . "\0" . 'alt');
        }
