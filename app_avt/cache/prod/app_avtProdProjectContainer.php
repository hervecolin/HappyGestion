...
/*
 * app_avtProdProjectContainer.
 *
 * This class has been auto-generated
 * by the Symfony Dependency Injection Component.
 */
class app_avtProdProjectContainer extends Container
{
    private $parameters;
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'imie.extra' => 'getImie_ExtraService',
            'imie.fct' => 'getImie_FctService',
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'avt', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\IMIE\\IMIEBundle\\Entity'))), 'IMIE\\IMIEBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('IMIEBundle' => 'IMIE\\IMIEBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_62d2dc6f6886e121a4f679bbfbac9eb33a49c466418decb9a828a38cfcb79e87');
    ...
    /*
     * Gets the 'imie.extra' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \IMIE\IMIEBundle\Extra\ExtraFonction A IMIE\IMIEBundle\Extra\ExtraFonction instance
     */
    protected function getImie_ExtraService()
    {
        return $this->services['imie.extra'] = new \IMIE\IMIEBundle\Extra\ExtraFonction();
    }

    /*
     * Gets the 'imie.fct' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \IMIE\IMIEBundle\FCT\IMIEFonction A IMIE\IMIEBundle\FCT\IMIEFonction instance
     */
    protected function getImie_FctService()
    {
        return $this->services['imie.fct'] = new \IMIE\IMIEBundle\FCT\IMIEFonction();
    }
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, ($this->targetDirs[2].'/config/routing.yml'), array('cache_dir' => __DIR__, 'debug' => false, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'app_avtProdProjectContainerUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'app_avtProdProjectContainerUrlMatcher', 'strict_requirements' => NULL), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\IMIE\\IMIEBundle/Resources/views'), 'IMIE');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58de163a6fa5a3.03295581')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'IMIEBundle' => 'IMIE\\IMIEBundle\\IMIEBundle',
            ),
            'kernel.bundles_metadata' => array(
                ...
                'IMIEBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\IMIE\\IMIEBundle'),
                    'namespace' => 'IMIE\\IMIEBundle',
                ),
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'app_avtProdProjectContainer',
            ...
            'router.options.matcher.cache_class' => 'app_avtProdProjectContainerUrlMatcher',
            'router.options.generator.cache_class' => 'app_avtProdProjectContainerUrlGenerator',
            'router_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\RouterListener',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.resource' => ($this->targetDirs[2].'/config/routing.yml'),
            'router.cache_class_prefix' => 'app_avtProdProjectContainer',
            ...
            'assetic.sass.bin' => 'C:\\Ruby22-x64\\bin\\sass',
