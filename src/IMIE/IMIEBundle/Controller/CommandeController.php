...
use IMIE\IMIEBundle\Entity\Commande;
use IMIE\IMIEBundle\Form\CommandeType;
...
class CommandeController extends Controller
{
    ...
    public function index___Action()
    {
       ...
       $entities = $em->getRepository('IMIEBundle:Commande')->findAll();
        return $this->render('IMIEBundle:Commande:index.html.twig', array(
            'entities' => $entities,
        )); 
    }
    ...
    public function indexAction()
    {
       ...
       /* $entities = $em->getRepository('IMIEBundle:Commande')->findAll();
		...
		$commandes=$em->getRepository('IMIEBundle:LigneCommande')->findCommandes();
		var_dump($commandes);
		die;
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('IMIEBundle:Commande:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IMIEBundle:Commande')->find($id);
        ...
        return $this->render('IMIEBundle:Commande:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('IMIEBundle:Commande:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
	...
	public function lignecommandeAction($id){
        $em = $this->getDoctrine()->getManager();
        $commande = $em->getRepository('IMIEBundle:Commande')->find($id);
		...
		return $this->render('IMIEBunle:LigneCommande:ajoutLigneCommande.html.twig', array(
			'form'=>$form->createView(),
			'commande'=>$commande,
		));
